...
public class AutoAlignWithReefCommandGroup extends SequentialCommandGroup {
    ...
    public AutoAlignWithReefCommandGroup(int reefIndex) {
        ...
        addCommands(new PathfindToPoseCommand(reefPose.transformBy(Constants.ReefConstants.AlignConstants.alignOffset.times(1.2)), 0), new MoveToPoseCommand(reefPose.transformBy(Constants.ReefConstants.AlignConstants.alignOffset), true));
    }
}
